...
packages:
  ...
  /flumedb/0.4.6:
    ...
    dev: true
    resolution:
      integrity: sha1-wa/6cpXDZy5VF06yR5Uvl2aRfo8=
  /flumelog-offset/3.2.7:
    dependencies:
      aligned-block-file: 1.1.2
      append-batch: 0.0.1
      explain-error: 1.0.4
    ...
    dev: true
    resolution:
      integrity: sha512-41vF3WvdoLi7vOiobmGUNUh0L/mB/55IcHkvzqkXCLr1RC/H8/qHcwkq71oG7rSQTW5I3L/aiXm0nyFu0AmpYw==
  ...
  /flumeview-level/3.0.4:
    dependencies:
      ...
      pull-write: 1.1.4
    resolution:
      integrity: sha512-NK0w/fDvUEKpeOHoeatpzLdsHvwxIYQM1K7MfxvoLrtKTysik0Us/daoO9yebXVqgjSpcdZZaGuTq5KbfYul0Q==
  ...
  /map-filter-reduce/3.0.7:
    ...
    dev: true
    resolution:
      integrity: sha512-B7D6q6wm6UE+vcTozUPdROwJp/SQJGrNcD4+M81oVBmVCR1hX7bRHAvzwyiQUsGFAOfp62mno440Wg3RK/MBlA==
  /map-merge/1.1.0:
    dev: true
    resolution:
  ...
  /scuttle-testbot/1.1.5:
    ...
    dev: true
    resolution:
      integrity: sha512-ugtl0Fq5hUc8X1quVbuWD3exow2Q7xc+R7SmawZRC0DEgXEdpvokoC57CIcPeY3PySaBbeekZ+OZZ4LONvxjNw==
  /scuttlebot/10.5.2:
    dependencies:
      atomic-file: 0.0.1
      bash-color: 0.0.4
  ...
  /ssb-typescript/1.3.0:
    dev: false
    resolution:
      integrity: sha512-iS7QDG2Jn/o9jK8LzxmmxOfwx87e5HWP7IYVqn7I+YZxIAWOXl0Vn2c6A8/N9VkWGF/g1sO874nDpncnquUR1A==
  /ssb-validate/3.0.8:
    dependencies:
      ssb-ref: 2.11.1
    dev: true
    resolution:
      integrity: sha512-3MYgNQAMGsuIPQsCnwcHW1EciWA/28EfHIlkPifpOIwFYY5jkbFuaKIzAyB8EPV/t4t84rUSh/GhORpWWMwcrg==
  /ssb-ws/1.0.3:
    dependencies:
      emoji-server: 1.0.0
      multiblob-http: 0.2.1
